 ...
 *
 * [Change language].
 * Specify language character for #lang. The character that can be specified is "ja","en".
 ...
 * The character that can be specified is "ja","en".
 * Do not include double quotation marks.
 *
 ...
 * @desc The characters that can be specified are "ja","en".
 * 
 ...
 * @desc When using language patch mode, specify the first variable to store language availability. Ensure at least 10 free variables from this point. Languages are stored in order: "ja","en","zh-cn","zh-tw","ko","es","de","fr","it","ru".
 * @type variable
 * @default -1
 * 
...
Langscore.FontList = {
	"ja": {name:"M+ 1m regular", size:28, fileName: "mplus-1m-regular.ttf", isLoaded : false }, 
	"en": {name:"M+ 1m regular", size:28, fileName: "mplus-1m-regular.ttf", isLoaded : false }, 
}
